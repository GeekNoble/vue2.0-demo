	...
	<div class="sales-board">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <v-chooser
                  :selections="periodList" @on-change="onParamChange('period',$event)"
                  ></v-chooser>
              </div>
          </div>
          <div class="sales-board-line">
      ...
      <div class="sales-board-des">
       ...
       <!--银行选择窗口-->
     <my-dialog :isShow="isShowDialog" @on-close="hideDialog">
         <table class="buy-dialog-table">
          ...
          <tr>
            ...
            <td>{{ period.label }}</td>
            <td>
              <span v-for="item in versions" style="padding-left:10px ">{{ item.label }}</span>
            </td>
            <td>{{ price }}</td>
          </tr>
        </table>
      ...
      <my-dialog :isShow="isShowErrDialog" @on-close="hideErrDialog">支付失败</my-dialog>
      <!--支付窗口-->
...
export default {
  ...
  methods:{
    ...
    getPrice(){
      ...
      this.$http.get('/api/getPrice',reqPrice).then((res)=>{
    ...
    confirmBuy(){
      ...
      .then((res) => {
        ...
        this.isShowCheckOrder=true;  //让支付窗口弹出
        this.isShowDialog=false;  //让选择银行窗口消失
      }, (err) => {
